...
//       console.log(" App started — checking login...");
...
//           }
//         } else {
//           console.log(" No token or userData found, going to login");
//           router.replace("/login");
//         }
//       } catch (error) {
...
export default function Index() {
  useEffect(() => {
    // 🚀 Get push token when app starts
    registerForPushNotificationsAsync().then((pushToken) => {
      if (pushToken) {
        console.log("✅ Push token ready:", pushToken);

        // 👉 TODO: Send this token to your backend with logged-in user ID
      }
    });
