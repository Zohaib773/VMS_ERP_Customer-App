...
//                     console.log("ALL DEVICES:", parsedUser);
//                 }
...
//     useEffect(() => {
//         if (loggedInUser?.id) {
//             console.log("🚀 Fetching devices for user id:", loggedInUser.id);
...
//         if (!device.is_claimed) return "#FFA500"; // Orange for unclaimed
//         return device.armed ? "#22C55E" : "#EF4444"; // Green for armed, Red for disarmed
//     };
...
//                         <Text style={styles.detailValue}>{formatDate(device.claimed_at)}</Text>
//                     </View>
//                 )}
//             </View>
