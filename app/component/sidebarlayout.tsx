...
// Customer-specific menu items with updated colors for dark mode
const menuItems: MenuItem[] = [
  { id: 1, title: "Dashboard", icon: "dashboard", route: "/Dashboard/Dashboard", color: "#4FC3F7" },
  { id: 2, title: "My Devices", icon: "shopping-bag", route: "/Dashboard/All_devices", color: "#81C784" },
];
...
export default function CustomerSidebarLayout({ activeTab, children }: Props) {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#0a0e1a" }}>
      ...
      <View style={[styles.topBar, { marginTop: statusBarHeight }]}>
        <TouchableOpacity onPress={toggleSidebar} style={styles.menuButton}>
          <Feather name={sidebarOpen ? "x" : "menu"} size={24} color="#e5e7eb" />
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.profileButton}>
          <MaterialIcons name="account-circle" size={40} color="#4FC3F7" />
        </TouchableOpacity>
      </View>
      ...
      <View style={{ flex: 1, flexDirection: "row" }}>
        ...
        >
          ...
          >
              ...
              {menuItems.map((item) => (
                ...
                >
                  <View
                    style={[
                      styles.menuIconContainer,
                      { backgroundColor: activeTab === item.title ? item.color : "#1a1f2e" },
                    ]}
                  >
                    <MaterialIcons
                      name={item.icon}
                      size={22}
                      color={activeTab === item.title ? "#ffffff" : item.color}
                    />
                  </View>
                  <Text style={[styles.menuText, activeTab === item.title && styles.activeMenuText]}>
                    {item.title}
            ...
            <TouchableOpacity style={styles.logoutButton} onPress={handleLogout}>
              <View style={styles.logoutIconContainer}>
                <MaterialIcons name="logout" size={22} color="#EF9A9A" />
              </View>
              <Text style={styles.logoutText}>Logout</Text>
            </TouchableOpacity>
          </ScrollView>
...
const styles = StyleSheet.create({
  ...
  sidebar: {
    width: 250,
    backgroundColor: "#1a1f2e", // Dark sidebar background
    borderRightWidth: 1,
    borderRightColor: "#2a2f3e", // Dark border
    zIndex: 10,
    elevation: 5,
    shadowColor: "#000",
  ...
  profileAvatar: { 
    ...
    height: 80, 
    borderRadius: 40, 
    backgroundColor: "#4FC3F7", // Light blue for dark mode
  ...
  activeMenuItem: { 
    backgroundColor: "rgba(79, 195, 247, 0.1)" // Subtle blue tint
  },
  menuIconContainer: { 
    width: 40, 
    height: 40, 
  ...
  logoutIconContainer: { 
    ...
    height: 40, 
    borderRadius: 8, 
    backgroundColor: "rgba(239, 154, 154, 0.15)", // Subtle red tint
    justifyContent: "center", 
    alignItems: "center", 
    marginRight: 15 
  },
